...
# Usage:
#
# cpu_get_lscpu_value "Architecture"
#
cpu_get_lscpu_value()
{
    local KEY="$1"
...
# Usage:
#
# cpu_get_cpuinfo_value "model name"
#
...
cpu_002()
{
    ...
    #
    # Neither Model nor Hardware Found
    #
